...
ggplot(iris, 
       aes(x = Sepal.Length, 
           y = Sepal.Width)) + 
  geom_point(colour = "red", shape = 11)
```
...
p1 <- ggplot(mtcars, 
             aes(x = reorder(rownames(mtcars), mpg), 
                 y = mpg)) + 
